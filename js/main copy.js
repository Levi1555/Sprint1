...
function renderCell(elCell, i, j, level) {
    ...
    if (gBoard[i][j].isRightClick) {
        ...
        strHTML += `<td data-i="${i}" data-j="${j}" onclick="cellClicked(this,${i},${j},${level})"  onmousedown="celldown(this,${i},${j})" onmouseenter="cellEnter(this,${i},${j},${level})" onmouseleave="cellLeave(this,${i},${j})" oncontextmenu="rightClick(this,${i},${j},${level})" class="cell not-pressed ${className}">${showName}</td>`;
        ...
        if (gBoard[i][j].isMarked) {
            ...
            strHTML += `<td data-i="${i}" data-j="${j}" onclick="cellClicked(this,${i},${j},${level})"  onmousedown="celldown(this,${i},${j})" onmouseenter="cellEnter(this,${i},${j},${level})" onmouseleave="cellLeave(this,${i},${j})" oncontextmenu="rightClick(this,${i},${j},${level})" class="cell pressed ${className}">${showName}</td>`;
